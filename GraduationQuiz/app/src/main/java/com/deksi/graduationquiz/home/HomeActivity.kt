...
class HomeActivity : AppCompatActivity() {
    ...
    private fun appBarSetup() {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_profile, R.id.nav_logout, R.id.nav_ranking_list, R.id.nav_sudoku_ranking_list
            ), drawerLayout
        )
...
//        Log.d("TokenAfterLogout", "Token has been destroyed")
    ...
    override fun onBackPressed() {
        ...
        val yesSpannable = SpannableString(yes).apply {
            setSpan(ForegroundColorSpan(ContextCompat.getColor(this@HomeActivity, R.color.textColor)), 0, length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
